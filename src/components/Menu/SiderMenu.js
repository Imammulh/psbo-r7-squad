...
function SiderMenu() {
  return (
    ...
    >
      ...
      {/* Sampai sini */}
      <Menu style={{ backgroundColor: 'transparent', border: 0, marginTop: '16px' }} mode="inline" defaultSelectedKeys={['1']}>
        ...
        <SubMenu key="sub1" icon={<IoDocumentText />} title="Pengajuan Insentif">
          <Menu.Item key="3">
