      ...
      <MyCard>
        ...
        <Form>
          ...
          <Form.Group as={Row} className="mb-3" controlId="nama">
            ...
            <Col sm={8}>
              <Select showSearch style={{ width: "100%" }} placeholder="Pilih skala kegiatan" optionFilterProp="children" onChange={onChange} filterOption={(input, option) => option.children.toLowerCase().indexOf(input.toLowerCase()) >= 0}>
                <Option value="kota">Kabupaten / Kota</Option>
                <Option value="provinsi">Provinsi</Option>
                <Option value="regional">Regional Wilayah (Kurang dari 5 provinsi)</Option>
              </Select>
            </Col>
          </Form.Group>
